...
/*
 * Köp representerar ett köptillfälle, med ett datum, ett antal
 * produktrader och ett antal rabatter.
 * 
 * Den har metoder som beräknar summan, beräknar summan utan att ta med rabatterna i
 * beräkningen och beräknar den totalla rabatten på köpet.
 * 
 * Man lägga till/ta bort en produktrad, lägga till en rabatt och få ut
 * en formatterad sträng för kvittot eller en sträng för raden för en viss produkt.
 * 
 * Det går att kolla om man redan använt en rabatt eller om det redan finns en
 * produktrad med en viss produkt med i köpet.
 */
...
public class Köp implements Serializable {
    ...
    public boolean använtRabatt(String rabattkod) {
    ...
    // inte helt 100% att den ska ligga här.
    public String skrivKvitto() {
        ...
        if(rabatter.size() > 0){
            ...
            for(String elem : rabatter){
                ...
                kvitto.append( String.format("%66s", ("-" + String.format( "%.2f", rabattRegister.rabattPåKöp(this, elem) ) + "kr\n") ));
            }
    ...
    public String hämtaProduktrad(Produkt produkt) {
        int i = 0;
        ...
        if (i < produkter.size())
            ...
            System.out.println("Ingen " + produkt + "finns registrerad i köpet.\n");
            return "";
        }
    }
