...
/*
 * Objektet Färskvaror ärver metoder ifrån Produkt.
 * Lägger till attributet bäst före datum på produkten.
 * Färskvaror innehåller metoder som kan sätta ett bäst före datum
 * samt hämta ett bäst före datum.
 */
